...
class SeleniumViewTests(StaticLiveServerTestCase):
    ...
    def test_items_and_get_results(self):
        """Tests the add/remove item flow and get results."""
    ...
    def test_blueprint_export(self):
        ...
        self.selenium.get(f"{self.live_server_url}/distribute/")
        self.selenium.find_element(By.ID, "user-item-input").send_keys("belt")
        self.selenium.find_element(By.ID, "user-count-input").send_keys("1")
