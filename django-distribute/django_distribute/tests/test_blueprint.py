...
class TestBlueprint(TestCase):
    ...
    def test_generate_bare_blueprint_book_json(self):
        ...
        bpb = {"blueprint_book":{"blueprints":[{}],"item":"blueprint-book","active_index":0,"version":562949958205441}}
        self.assertEqual(generate_book([{}]), bpb)
    ...
    def test_generate_bare_chest_json(self):
        ...
        chest = {
            "blueprint": {
                "icons": [
                    {"signal": {"name": "requester-chest"}, "index": 1}
                ],
                "entities": [
                    {
                        "entity_number": 1,
    ...
    def test_generate_populated_bp(self):
        text = b'{"blueprint_book":{"blueprints":[{"blueprint":{"icons":[{"signal":{"name":"requester-chest"},"index":1}],"entities":[{"entity_number":1,"name":"requester-chest","position":{"x":-95.5,"y":-198.5},"request_filters":{"sections":[{"index":1,"filters":[{"index":1,"name":"transport-belt","quality":"normal","comparator":"=","count":100},{"index":2,"name":"chemical-plant","quality":"normal","comparator":"=","count":2}]}],"trash_not_requested":true}}],"item":"blueprint","label":"1","version":562949958205441},"index":0},{"blueprint":{"icons":[{"signal":{"name":"requester-chest"},"index":1}],"entities":[{"entity_number":1,"name":"requester-chest","position":{"x":-95.5,"y":-198.5},"request_filters":{"sections":[{"index":1,"filters":[{"index":1,"name":"crusher","quality":"normal","comparator":"=","count":10},{"index":2,"name":"thruster","quality":"normal","comparator":"=","count":3}]}],"trash_not_requested":true}}],"item":"blueprint","label":"2","version":562949958205441},"index":1}],"item":"blueprint-book","active_index":0,"version":562949958205441}}'
